...
@Suite("Apple Email Format Tests")
struct AppleEmailTests {

    // MARK: - Basic AppleEmail Creation

    @Test("Create AppleEmail from simple Email")
    func createAppleEmailSimple() throws {
        let email = try Email(
    ...
    @Test("Create AppleEmail with custom UUID")
    func createAppleEmailCustomUUID() throws {
    ...
    @Test("AppleEmail with HTML content")
    ...
    @Test("AppleEmail with multipart content")
    ...
    @Test("AppleEmail with all email fields")
    ...
    @Test("AppleEmail from EmailDocument")
    ...
    @Test("AppleEmail produces valid .eml structure")
    ...
    @Test("AppleEmail with HTML builder content")
    ...
    @Test("AppleEmail with styled HTML content")
